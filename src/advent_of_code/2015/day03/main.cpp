...
auto main() noexcept -> int
{
  ...
  const std::vector<std::filesystem::path> possible_paths = {
    ...
    "src/advent_of_code/2015/day03/input.txt",          // For direct execution from project root
    "../../../src/advent_of_code/2015/day03/input.txt"  // For clion execution (executable in build/bin/Debug)
  };

  const std::vector<char> input = Solution::parse_input(possible_paths);
